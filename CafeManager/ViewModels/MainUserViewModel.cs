...
namespace CafeManager.WPF.ViewModels
{
    public partial class MainUserViewModel : ObservableObject, IDisposable
    {
        ...
        [ObservableProperty]
        private Coffeetable? _selectedTable = new();
        ...
        private void ChooseTable(Coffeetable table)
        {
            try
            {
                ...
                {
                    MessageBoxResult messageBox = MessageBox.Show($"Bạn muốn tạo hóa đơn cho {table.Tablename} ?", "Thông báo", MessageBoxButton.YesNo, MessageBoxImage.Question);
        ...
        private void ChooseFood(FoodDTO food)
        {
            ...
            {
                MessageBox.Show("Vui lòng chọn bàn hoặc tạo hóa đơn mới");
            }
        }
